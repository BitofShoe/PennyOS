...
> Do not use this for: the current first stop. Prefer [docs/penny-progress-handoff-2026-04-17.md](../penny-progress-handoff-2026-04-17.md), [docs/README.md](../README.md), and the current runtime docs first.
...
- prompt-slot assembly via [lib/penny-prompt-stack.js](../../lib/penny-prompt-stack.js)
- lane-aware overlays via [penny-voice/runtime/penny-overlays.json](../../penny-voice/runtime/penny-overlays.json)
- scoped memory books via [lib/penny-memory-books.js](../../lib/penny-memory-books.js)
- archive session chapters and compression fallback via [lib/penny-memory-archive.js](../../lib/penny-memory-archive.js)
- expression-pack manifest runtime via [public/sprites/packs/default/manifest.json](../../public/sprites/packs/default/manifest.json) and [public/js/penny-expression-runtime.mjs](../../public/js/penny-expression-runtime.mjs)
...
- browser ownership:
  - [public/js/penny-expression-runtime.mjs](../../public/js/penny-expression-runtime.mjs)
  - [public/js/penny-transcript-ui.mjs](../../public/js/penny-transcript-ui.mjs)
  - [public/js/penny-memory-panel.mjs](../../public/js/penny-memory-panel.mjs)

The follow-up cleanup pass also removed the dead duplicated wrapper bodies from [public/js/penny-app.js](../../public/js/penny-app.js), so the browser shell is now much closer to a real orchestrator.
...
- [test/penny-routes.test.js](../../test/penny-routes.test.js)
...
- [test/penny-native-upgrades.todo.test.js](../../test/penny-native-upgrades.todo.test.js)
...
- [lib/penny-memory-books.js](../../lib/penny-memory-books.js)
...
- [public/js/penny-app.js](../../public/js/penny-app.js)
- [public/js/penny-expression-runtime.mjs](../../public/js/penny-expression-runtime.mjs)
- [public/js/penny-transcript-ui.mjs](../../public/js/penny-transcript-ui.mjs)
- [public/js/penny-memory-panel.mjs](../../public/js/penny-memory-panel.mjs)
