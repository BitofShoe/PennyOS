# Penny Voice Canon Sources

Primary Penny voice docs used for this pass:
...
- The in-repo `Penny's Playground/PENNY'S_BRAIN.md` exists, but it is mostly rebuild/code context, not the strongest live voice source.
- Raw files remain the canon. Distilled files below are working compression layers.
