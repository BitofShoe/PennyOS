...
const SEMANTIC_PREDICATE_IDS = Object.freeze({
  ...
  SUPPORTS: 'penny:predicate:supports',
  EVIDENCE_FOR: 'penny:predicate:evidence-for',
  USER_PREFERENCE_EVIDENCE: 'penny:predicate:user-preference-evidence',
  RESEARCH_PATTERN_FOR: 'penny:predicate:research-pattern-for',
  RELATED_BUT_WEAK: 'penny:predicate:related-but-weak',
...
const RAW_PREDICATES = Object.freeze([
  ...
  {
    id: SEMANTIC_PREDICATE_IDS.CURRENT_CORRECTION_FOR,
    label: 'current correction for',
    subjectTypes: ['claim', 'memory-item', 'archive-episode'],
    objectTypes: ['claim', 'memory-item', 'archive-episode'],
    inversePredicateId: SEMANTIC_PREDICATE_IDS.STALE_PRIOR,
    authorityBehavior: AUTHORITY_BEHAVIORS.DOES_NOT_CANONIZE,
  ...
  {
    id: SEMANTIC_PREDICATE_IDS.SUMMARY_OF,
    label: 'summary of',
    subjectTypes: ['summary', 'claim', 'memory-item', 'archive-episode'],
    objectTypes: ['claim', 'memory-item', 'archive-episode', 'research-topic', 'source'],
    authorityBehavior: AUTHORITY_BEHAVIORS.DOES_NOT_CANONIZE,
    stalenessBehavior: STALENESS_BEHAVIORS.NONE,
    canInfluenceRanking: true,
    canPromoteToExplicitMemory: false,
  ...
  {
    id: SEMANTIC_PREDICATE_IDS.SUPPORTS,
    label: 'supports',
    subjectTypes: ['claim', 'memory-item', 'archive-episode', 'source', 'tool-evidence'],
    objectTypes: ['claim', 'memory-item', 'archive-episode', 'research-topic'],
    authorityBehavior: AUTHORITY_BEHAVIORS.DOES_NOT_CANONIZE,
    stalenessBehavior: STALENESS_BEHAVIORS.NONE,
    canInfluenceRanking: true,
  ...
  {
    id: SEMANTIC_PREDICATE_IDS.EVIDENCE_FOR,
    label: 'evidence for',
    subjectTypes: ['claim', 'memory-item', 'archive-episode', 'source', 'tool-evidence'],
    objectTypes: ['claim', 'memory-item', 'archive-episode', 'research-topic', 'plan'],
    authorityBehavior: AUTHORITY_BEHAVIORS.DOES_NOT_CANONIZE,
    stalenessBehavior: STALENESS_BEHAVIORS.NONE,
    canInfluenceRanking: true,
    canPromoteToExplicitMemory: false,
  ...
  {
    id: SEMANTIC_PREDICATE_IDS.USER_PREFERENCE_EVIDENCE,
    label: 'user preference evidence',
    subjectTypes: ['claim', 'memory-item', 'archive-episode'],
    objectTypes: ['user', 'preference', 'claim', 'memory-item'],
    authorityBehavior: AUTHORITY_BEHAVIORS.DOES_NOT_CANONIZE,
    stalenessBehavior: STALENESS_BEHAVIORS.NONE,
    canInfluenceRanking: false,
    canPromoteToExplicitMemory: false,
  ...
  {
    id: SEMANTIC_PREDICATE_IDS.RESEARCH_PATTERN_FOR,
    label: 'research pattern for',
    subjectTypes: ['research-topic', 'claim', 'memory-item', 'archive-episode'],
    objectTypes: ['research-topic', 'plan', 'claim', 'project'],
    authorityBehavior: AUTHORITY_BEHAVIORS.DOES_NOT_CANONIZE,
    stalenessBehavior: STALENESS_BEHAVIORS.NONE,
    canInfluenceRanking: true,
    canPromoteToExplicitMemory: false,
  ...
  {
    id: SEMANTIC_PREDICATE_IDS.RELATED_BUT_WEAK,
    label: 'related but weak',
    subjectTypes: ['claim', 'memory-item', 'archive-episode', 'research-topic'],
    objectTypes: ['claim', 'memory-item', 'archive-episode', 'research-topic'],
    authorityBehavior: AUTHORITY_BEHAVIORS.DOES_NOT_CANONIZE,
    stalenessBehavior: STALENESS_BEHAVIORS.NONE,
