...
| [plans/penny-static-embedding-live-advisory-plan-2026-04-22.md](./plans/penny-static-embedding-live-advisory-plan-2026-04-22.md) | Static embedding live sidecar plan | Implementation plan | Draft | Slice 0 provider decision record, live-shadow/live-advisory mode ladder, dependency posture, guardrails, and ten-slice static embedding run map | proof that live static retrieval shipped, default embedding-provider law, PromptTruth expansion, or canonical memory authority |
