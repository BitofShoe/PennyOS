...
| [penny-tier1-aliveness-plans/README-tier1-bounded-aliveness-plans.md](./penny-tier1-aliveness-plans/README-tier1-bounded-aliveness-plans.md) | Tier 1 bounded-aliveness plan bundle | Implementation plan | Current planning handoff | the five bounded-aliveness plan handoffs, north-star sentence, global guardrails, and slice order for static memory reflex, turn-state, open loops, initiative, and aliveness compare work | proof that any slice shipped, runtime default law, prompt-limit changes, PromptTruth expansion, or unrequested initiative |
